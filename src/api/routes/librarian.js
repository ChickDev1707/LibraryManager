...
router
  .route("/books/import")
  .post(
    bookController.uploadBook.single("uploadfile"),
...
router
  ...
  .post(
    readerController.uploadReader.single("uploadfile"),
...
//Order
// router.route("/confirm-order").get(orderController.getOrders);
