...
router.delete(
  "/cart/register-tickets/:id",
  registerBorrowController.deleteBookHeadFromCart
);
router.delete(
  "/cart/register-tickets",
  registerBorrowController.deleteSelectedBookHeadFromCart
);

// register borrow book ----------
router.post("/cart/register", registerBorrowController.registerBorrowBook);
router
  .route("/register-tickets")
  .get(registerBorrowController.showViewRegisterPage);

// view borrow book
router.route("/borrow-cards").get(borrowBookController.showViewBorrowCardsPage);
...
router
  ...
  .put(
    accountUpdateMiddleware.checkUpdateProfile,
    accountController.updateUser
  );

//fine
router.route("/fine").get(fineController.getFinePage);
//reader
router
...
router.route("/yourOrder").get(orderController.GetAllOrder);
